      ...
      <div className="flex-1 relative flex items-center justify-center overflow-hidden">
        ...
        >
          {({ zoomIn, zoomOut, resetTransform }) => (
            <>
              <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 p-2 rounded-full bg-black/40 backdrop-blur-md border border-white/10 text-white">
        ...
        <button 
          onClick={onNext}
          className="absolute right-4 z-20 p-3 rounded-full bg-black/20 hover:bg-black/40 backdrop-blur-md transition-colors text-white"
        >
